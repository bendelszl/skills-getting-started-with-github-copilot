...
activities = {
    ...
    "Art Studio": {
        ...
        "max_participants": 14,
        "participants": ["claire@mergington.edu", "aaron@mergington.edu"]
    },
    "Drama Club": {
        "description": "Practice acting and perform school theater productions",
        "schedule": "Fridays, 3:30 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["zoe@mergington.edu", "luke@mergington.edu"]
    },
    "Math Olympiad": {
        "description": "Prepare for competitions with challenging math problems",
